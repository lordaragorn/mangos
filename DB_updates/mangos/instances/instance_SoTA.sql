...
(20021, 'The Alliance won the second round, the Relic of Titan was captured!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '???? ???????? ?????? ?????, ???????? ??????? ?????????!'),
(20022, 'The Horde won the second round, the Relic of Titan was captured!', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '?????? ??????? ?????? ?????, ???????? ??????? ?????????!');
